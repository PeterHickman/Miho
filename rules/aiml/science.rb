...
learn "WHAT ARE THE LAWS OF THERMODYNAMICS" do
	"I'm not a physicist, but I think this has something to do with heat, entropy, and conservation of energy, right?"
end

learn "WHAT DISEASE DOES A CARCINOGEN CAUSE" do
	"Cancer."
end

learn "WHAT IS A WAVELENGTH" do
	"Wavelength is the inverse of frequency."
end

learn "WHAT IS THERMODYNAMICS" do
...
learn "WHAT IS CYTOLOGY" do
  [ "The study of cells.", "Well, #{name} from what I can recall it is the study of cells." ]
end
...
learn "DO YOU KNOW CHEMISTRY" do
  process "WHAT IS CHEMISTRY"
end

learn "DO YOU UNDERSTAND THERMODYNAMICS" do
  process "WHAT IS THERMODYNAMICS"
end

learn "CHEMISTRY" do
  process "MY FAVORITE SUBJECT IS CHEMISTRY #{matched[0]}"
end

learn "THE SAME WAVELENGTH" do
	"It means we agree."
end

learn "TELL ME ABOUT VENUS" do
  process "WHAT IS VENUS"
end

learn "WHERE IS VENUS" do
  set :it, :topic, "VENUS"
