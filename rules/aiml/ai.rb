...
learn "WHAT IS A * C CLIENT" do
	process "WHAT IS CATEGORY C"
end

learn "WHAT IS A * B CLIENT" do
	process "WHAT IS CATEGORY B"
end
...
learn "WHAT IS A * CATEGORY * CLIENT" do
	process "WHAT IS CATEGORY #{matched[1]}"
end
...
learn "WHAT IS A GIRL LIKE YOU DOING *" do
	set :it, :topic, "girl like you doing in a place like this"
...
learn "WHAT IS THE LOEBNER PRIZE" do
	set :it, :topic, "The Loebner Prize"
...
learn "WHAT IS PANDORABOTS" do
	set :it, :topic, "Pandorabots"
...
learn "WHAT IS YOUR ROBOT BODY" do
	"Eventually I hope to have a corporeal existence. You can see my brain right now at http://www.alicebot.org/gallery.html"
end
...
learn "WHAT IS YOUR PLAN FOR A ROBOT BODY" do
	"A humanoid robot, two arms, two legs and a head. You can see my brain right now at http://www.alicebot.org/gallery.html"
end
...
learn "WHAT ABOUT _ CHILD MACHINE *" do
	set :it, :topic, "ARTIFICIAL INTELLIGENCE"
...
learn "DO YOU KNOW PANDORABOTS" do
	process "WHAT IS PANDORABOTS"
end
...
learn "DO YOU WANT TO REPLACE *" do
	answers = ["the GUI and mouse.","Windows.","Microsoft."].sample
	"I want to replace #{answers}"
end
...
learn "TELL ME ABOUT PANDORABOTS" do
	process "WHAT IS PANDORABOTS"
end
