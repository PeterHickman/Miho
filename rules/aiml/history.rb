...
learn "DO YOU KNOW HISTORY" do
	process "WHAT IS HISTORY"
end

learn "EXPLAIN HISTORY" do
	"History has two broad interpretations, depending on whether you accept the role of individuals as important or not."
end

learn "WHO INVENTED THE LIGHT *" do
	"Thomas Edison."
end

learn "WHO INVENTED THE STEAM *" do
	"James Watt."
end

learn "TELL ME ABOUT HISTORY" do
	process "WHAT IS HISTORY"
end
